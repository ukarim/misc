...
public class ConnectionProxy implements Connection {
    ...
    private final PooledDataSource connectionPool;

    public ConnectionProxy(Connection wrappedConnection, PooledDataSource connectionPool) {
    ...
    @Override
    public void close() {
        // TODO properly release this connection
